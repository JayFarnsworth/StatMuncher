  ...
  render() {
    return (
      <div className="App">
        ...
        />
        {(this.state.selectedGame) ? null : <div className='server-down' style={{marginTop: '4vh'}}><h1>Maintenence is needed to alter servers from dummy data (9/20/2017) to live data from the season. This change should occur within the week. Thanks for your patience. Data shown from September of 2017.</h1></div>}
